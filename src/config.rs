...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RemoteAccess".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["52.60.131.131"];
pub const RS_PUB_KEY: &str = "IvAqrT5K5GnkaJstoNa2pSFcSOOUpRPmjHZpVAzXEp0=";
